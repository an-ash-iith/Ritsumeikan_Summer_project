...
#         c=class_list[d]
    ...
    for class_id,xyxy, confidence, tracker_id  in zip(detections.class_id, detections.xyxy, detections.confidence, detections.tracker_id):
        ...
        if class_name == 'car':
            ...
            file.write(str(datetime.datetime.fromtimestamp(time.time()))+"\t"+class_name + "\t" + str(confidence) + "\t" + str(xyxy[0]) + "\t" + str(xyxy[1]) + "\t" + str(xyxy[2]) + "\t" + str(xyxy[3])+ "\t" + str(tracker_id)+"\n")
